...
Start-MicroService -Dir (Join-Path $ProjectRoot "services\web_ui") -Name "web_ui" -Port 8090 -ExtraEnv $webUiEnv

Write-Host ""
Write-Host "Pipeline complet lance en mode REEL (connecte a vSphere)." -ForegroundColor Green
Write-Host "Interface web         : http://localhost:8090" -ForegroundColor Green
